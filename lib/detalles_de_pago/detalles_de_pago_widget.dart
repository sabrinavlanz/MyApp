...
class DetallesDePagoWidget extends StatefulWidget {
  const DetallesDePagoWidget({Key? key}) : super(key: key);

  @override
  _DetallesDePagoWidgetState createState() => _DetallesDePagoWidgetState();
}
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        'Las llaves las dejo en portería. Por favor me llaman al retirar a toby.',
                        style: FlutterFlowTheme.of(context).bodyText2,
                      ),
                    ),
                  ],
