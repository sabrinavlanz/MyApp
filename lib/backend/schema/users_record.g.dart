    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'isAdmin':
          ...
          break;
        case 'isEditor':
          result.isEditor = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool?;
          break;
        case 'IsMod':
          result.isMod = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool?;
          break;
        case 'cedula':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  bool? _isEditor;
  bool? get isEditor => _$this._isEditor;
  set isEditor(bool? isEditor) => _$this._isEditor = isEditor;
  ...
  double? _cedula;
  double? get cedula => _$this._cedula;
  set cedula(double? cedula) => _$this._cedula = cedula;
